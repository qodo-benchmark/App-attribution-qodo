...
function FloatingActionButtonAndPopover({onHideCreateMenu, onShowCreateMenu, ref}: FloatingActionButtonAndPopoverProps) {
    ...
    const startQuickScan = useCallback(() => {
        interceptAnonymousUser(() => {
            ...
            startMoneyRequest(CONST.IOU.TYPE.CREATE, quickActionReportID, CONST.IOU.REQUEST_TYPE.SCAN, false, undefined, allTransactionDrafts);
        });
        ...
        if (!isEmptyObject(policyChatForActivePolicy)) {
            const onSelected = () => {
                interceptAnonymousUser(() => {
                    ...
                    const quickActionReportID = policyChatForActivePolicy?.reportID || reportID;
                    startMoneyRequest(CONST.IOU.TYPE.CREATE, quickActionReportID, CONST.IOU.REQUEST_TYPE.SCAN, true, undefined, allTransactionDrafts);
                });
            };
